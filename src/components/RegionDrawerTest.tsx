...
export const RegionDrawerTest = (props: RegionDrawerProps) => {
    return (
        <Drawer.Root
            direction="left"
        ...
        >
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content className="bg-white flex flex-col h-full w-[400px] mt-24 fixed bottom-0 left-0 border">
